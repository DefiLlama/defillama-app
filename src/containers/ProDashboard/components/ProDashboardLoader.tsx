		...
		<div className="isolate flex flex-1 flex-col items-center justify-center gap-6 rounded-md border border-(--cards-border) bg-(--cards-bg) p-1">
			<div className="relative size-24">
				...
				<div className="absolute inset-0 animate-spin rounded-full [animation-duration:3s]">
					<div
						className="-z-10 size-full rounded-full border-2 border-transparent border-t-pro-purple-400 border-r-pro-purple-400 opacity-30"
						style={{
							background:
				...
				<div className="absolute inset-3 animate-spin rounded-full [animation-direction:reverse] [animation-duration:2s]">
					<div className="size-full rounded-full border-2 border-transparent border-b-pro-purple-400 border-l-pro-purple-400" />
				</div>
				...
				<div className="absolute inset-0 animate-spin [animation-duration:4s]">
					<div className="absolute top-0 left-1/2 -ml-1 size-2 rounded-full bg-pro-purple-400" />
				</div>
				<div className="absolute inset-0 animate-spin [animation-direction:reverse] [animation-duration:3s]">
					<div className="absolute bottom-0 left-1/2 -ml-0.75 size-1.5 rounded-full bg-pro-purple-400 opacity-60" />
				</div>
				...
				<div className="absolute inset-0 flex items-center justify-center">
					<div className="relative">
						<img
							...
							width={64}
							height={64}
							className="z-10 size-16 object-contain [animation-duration:1.5s]"
						/>
						<div
