...
export type ModalAction =
	...
	| { type: 'SET_SELECTED_YIELD_POOL'; payload: { configID: string; name: string; project: string; chain: string } | null }
	...
	| { type: 'RESET_STATE' }
	| { type: 'INITIALIZE_FROM_EDIT_ITEM'; payload: { editItem: DashboardItemConfig | null } }
...
function initializeFromEditItem(editItem: DashboardItemConfig | null): ModalState {
	if (!editItem) {
		return INITIAL_MODAL_STATE
	}

	const base = { ...INITIAL_MODAL_STATE }
