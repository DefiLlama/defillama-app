	...
	return (
		<div className="flex flex-col h-full">
			...
			<div className="flex-1 border pro-border p-3 flex flex-col min-h-0">
				...
				<div className="flex-1 pro-bg2 rounded flex items-center justify-center relative" style={{ minHeight: '500px' }}>
					{previewLoading ? (
						...
						<div className="text-center">
							...
							<p className="text-xs pro-text3 mt-1">
								Select metric and chains to generate chart
							</p>
						</div>
					)}
				</div>
				...
				<div className="mt-2 p-2 pro-bg2 rounded flex-shrink-0">
					<div className="flex items-start gap-1">
						...
						<p className="text-[10px] pro-text3 leading-relaxed">
							...
							{chartBuilder.categories.length > 0 && ` in ${chartBuilder.categories.join(', ')} categories`}.
							Data is displayed as {chartBuilder.displayAs === 'percentage' ? 'percentage of total' : 'absolute values'}.
						</p>
					</div>
				</div>
			</div>
