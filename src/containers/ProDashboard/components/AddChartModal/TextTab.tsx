		...
		<div className="space-y-3 md:space-y-4">
			<div>
				...
				<input
					...
					className="w-full px-3 py-2 border pro-border pro-bg2 pro-text1 placeholder:pro-text3 focus:border-(--primary) focus:outline-hidden text-sm md:text-base"
				/>
			</div>
			<div>
				...
				<textarea
					...
					rows={8}
					className="w-full px-3 py-2 border pro-border pro-bg2 pro-text1 placeholder:pro-text3 focus:border-(--primary) focus:outline-hidden resize-none font-mono text-xs md:text-sm md:rows-12"
				/>
