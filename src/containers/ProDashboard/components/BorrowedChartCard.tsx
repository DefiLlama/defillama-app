...
const CHART_TYPE_LABELS: Record<string, string> = {
	chainsBorrowed: 'Borrowed by Chain',
	tokenBorrowedUsd: 'Borrowed by Token (USD)',
	tokensBorrowedPie: 'Borrowed Tokens Breakdown (USD)',
	tokenBorrowedRaw: 'Borrowed by Token (Raw Quantities)'
}
...
export function BorrowedChartCard({ config }: BorrowedChartCardProps) {
	...
	}, [chainsSplit, tokenBreakdownUSD, tokenBreakdown, timePeriod])
