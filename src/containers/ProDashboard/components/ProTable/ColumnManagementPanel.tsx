...
const metricDescriptions: Record<string, string> = {
	...
	ps: 'Price to Sales ratio - market cap divided by annualized revenue; blank when annualized revenue is unavailable',
	pf: 'Price to Fees ratio - market cap divided by annualized fees; blank when annualized fees are unavailable',
