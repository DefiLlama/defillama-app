 ...
 *
 * @param seconds - Total number of seconds to format (>= 0)
 * @returns The duration formatted as `MM:SS`, zero-padded to two digits per field
 */
...
/**
 * Renders an animated ellipsis that cycles between one and three dots.
 *
 * The visible dot count updates every 500ms.
 *
 * @returns A span element containing one to three period characters (`'.'`) representing the animated dots.
 */
