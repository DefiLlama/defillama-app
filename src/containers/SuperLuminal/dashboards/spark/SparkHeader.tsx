...
function SparkLogo() {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 106 32" fill="none" className="h-7 shrink-0" style={{ width: 'auto', minWidth: 92 }}>
			<path
			...
			/>
			<defs>
				<linearGradient id="spark-logo-grad" x1="20.815" x2="4.893" y1="9.447" y2="21.239" gradientUnits="userSpaceOnUse">
