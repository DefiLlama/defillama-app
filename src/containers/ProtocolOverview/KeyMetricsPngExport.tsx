...
export function KeyMetricsPngExportButton({
	...
	const handleExport = async () => {
		...
		try {
			...
			const canvasHeight = padding * 2 + headerHeight + primaryValueHeight + rowsHeight + watermarkHeight
			...
			try {
				...
				const wmX = canvasWidth - padding - wmWidth
				const wmY = canvasHeight - padding - wmHeight + 8
