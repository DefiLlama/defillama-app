...
export const TableSwitch = () => {
	...
	return (
		<div className="p-3 flex items-center justify-start">
			<div className="text-sm font-medium flex items-center rounded-md overflow-x-auto flex-nowrap border border-[var(--form-control-border)] text-[#666] dark:text-[#919296]">
				<button
