export function SubscriptionBackground() {
	return (
		<div className="absolute inset-x-0 top-0 h-[625px] overflow-hidden md:h-[476px]">
			<div className="absolute inset-0 [background-image:var(--sub-grid-image-light)] [background-size:52px_52px] opacity-80 md:[background-size:74px_74px] dark:[background-image:var(--sub-grid-image-dark)] dark:opacity-80" />
