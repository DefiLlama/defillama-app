...
this is a straigh copy of index.js but with a column changed,
i haven't changed index.js because someone might be working on virtualizing it and i want to avoid merge conflicts

In the future these two files should be merged, since the code is almost the same
