...
const YieldsStrategyPage = ({ pools, projectList, chainList, categoryList, allPools }) => {
	...
	// for now, I'm keeping the search space smoller by only keeping single exposure token
	...
	const poolsData = React.useMemo(() => {
		...
		// now calc the total strategy apy
		...
		// keep pools with profitable strategy only, require at least 1% delta compared to baseline
