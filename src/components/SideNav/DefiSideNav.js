...
const NavMenu = () => {
  ...
  return (
    <Nav>
      <MobileOnlyEntry url="yields" name="Yields" history={history} Icon={Percent} style={{ marginTop: '20px' }} />
      ...
      <MobileOnlyEntry url="portfolio" name="Portfolio" history={history} Icon={Bookmark} />
