	...
	return (
		<Ariakit.PopoverProvider>
			...
			<Ariakit.Popover
				...
				gutter={6}
				className="z-10 max-h-[calc(100vh-80px)] w-full overflow-auto overscroll-contain rounded-md border border-[hsl(204,20%,88%)] bg-[hsl(204,20%,100%)] text-[hsl(204,10%,10%)] sm:max-w-[min(calc(100vw-16px),320px)] lg:max-h-[var(--popover-available-height)] dark:border-[hsl(204,3%,32%)] dark:bg-[hsl(204,3%,12%)] dark:text-[hsl(0,0%,100%)]"
			>
				<div className="p-1">
