...
export const volumesColumns = (allChains?: boolean): ColumnDef<IDexsRow>[] =>
	[
		...
		// Change7dColumn,
		// Change1mColumn,
		ChangeColumn('Change (7d-7d)', 'change_7dover7d', 160, 'Change of last 7d volume over the previous 7d volume'),
		Total24hColumn('Volume', undefined, `Yesterday's volume, updated daily at 00:00UTC`),
		Total24hColumn('Volume', 'total7d', `Comulative last 7d volume`, undefined, 'Volume (7d)'),
		TVLColumn,
