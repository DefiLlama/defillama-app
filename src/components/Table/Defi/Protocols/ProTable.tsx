...
export function ProtocolsByChainTable({ chain = 'All' }: { chain: string }) {
	...
	return (
		<div className="flex flex-col items-center h-full p-4">
			...
			<div className="isolate relative w-full max-w-[calc(100vw-8px)] rounded-md lg:max-w-[calc(100vw-228px-4px-16px)] overflow-x-auto mx-auto text-[var(--text1)] bg-[var(--bg8)] border border-[var(--bg3)]">
				<table>
					<thead>
