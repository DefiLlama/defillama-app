...
import { fetchWithPerformanceLogging, withPerformanceLogging } from '~/utils/perf'
...
export const getStaticProps = withPerformanceLogging(
	...
	async ({
		...
		const [protocolRes, articles, emissions, expenses, treasuries, yields, yieldsConfig, liquidityInfo]: [
			...
			fetchWithPerformanceLogging(PROTOCOL_EMISSIONS_LIST_API),
			fetchWithPerformanceLogging(PROTOCOLS_EXPENSES_API),
			fetchWithPerformanceLogging(PROTOCOLS_TREASURY),
			fetchWithPerformanceLogging(YIELD_POOLS_API),
			fetchWithPerformanceLogging(YIELD_CONFIG_API),
			fetchWithPerformanceLogging('https://defillama-datasets.llama.fi/liquidity.json')
		])
