		...
		<Layout title="DefiLlama - ChatGPT Plugin" defaultSEO>
			...
			<Panel style={{ marginTop: '6px' }}>
				<DashGrid style={{ height: 'fit-content', padding: '0 0 1rem 0' }}>
					...
					<Divider />
					<TYPE.main>To achieve the best results from the plugin, follow these steps:</TYPE.main>
					<TYPE.main>1. Ask "What features do you have?" to see the most recent feature list.</TYPE.main>
					<TYPE.main>
