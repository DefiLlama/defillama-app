...
async function handler(req: NextApiRequest, res: NextApiResponse) {
	...
	const url = `${MARKETS_SERVER_URL}/exchanges/${encodeURIComponent(exchange.toLowerCase())}/index.json`
	try {
...
export default withApiRouteTelemetry('/api/public/markets/exchange/[exchange]', handler)
