...
const PressPanel = ({ imageFilename }) => <Panel style={{ padding: '18px 25px' }}>
  <AutoColumn gap="4px">
        ...
        <FullWrapper>
          ...
          <Panel style={{ marginTop: '6px' }}>
            <DashGrid center={true} style={{ height: 'fit-content', padding: '0 0 1rem 0' }}>
              ...
              <Divider />
              <TYPE.main>You can download all our branding assets from <Link href="/defillama-press-kit.zip">here</Link>.</TYPE.main>
            </DashGrid>
          </Panel>
        </FullWrapper>
      </PageWrapper>
