...
const WHY_LLAMAAI_FEATURES = [
	...
	},
	{
		...
		description:
			"Get smart, context-aware prompt suggestions based on the protocol, chain, or page you're viewing. LlamaAI adapts to your current context for more relevant insights.",
		icon: (
			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
				<path
	...
	{
		title: 'LlamaAI Alerts',
		description:
			'Automated insights delivered to your inbox. Set up daily or weekly reports on any metric—get email alerts with onchain trends and key insights. Perfect for daily briefings.',
		icon: (
			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
	...
	},
	{
		...
		description:
			'Generate comprehensive, in-depth research reports on any DeFi topic. LlamaAI combines onchain data with real-time web search to deliver thorough analysis and insights.',
		icon: (
			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
				<path
				...
				<section className="relative z-10 px-4 pb-24 md:px-8 md:pb-32">
					<div className="mx-auto max-w-3xl">
						...
						<div className="divide-y divide-[#E8E8E8] border-t border-[#E8E8E8] dark:divide-[#2a2a2e] dark:border-[#2a2a2e]">
							...
							<FAQ question="How do alerts work?">
								<p className="mb-2">
									LlamaAI alerts let you set up automated reports delivered to your email on a schedule. Simply prompt
									what you want to track (e.g., "send me the fastest growing protocols by revenue daily at 9am"), set
									your preferred frequency and timing, and receive email alerts automatically.
								</p>
							</FAQ>
