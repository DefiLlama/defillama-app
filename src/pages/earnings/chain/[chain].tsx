...
export const getStaticPaths = async () => {
	...
	const chains = await fetchJson(
		`${DIMENSIONS_OVERVIEW_API}/${adapterType}?excludeTotalDataChartBreakdown=true&excludeTotalDataChart=true&dataType=dailyRevenue`
	)
...
export const getStaticProps = withPerformanceLogging(
	...
	async ({ params }: GetStaticPropsContext<{ chain: string }>) => {
		...
		const { questions: entityQuestions } = await fetchEntityQuestions(chain, 'chain', { subPage: 'earnings' })
