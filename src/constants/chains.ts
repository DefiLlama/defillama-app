...
export const LLAMASWAP_CHAINS = [
	...
	{ llamaswap: 'fantom', gecko: 'fantom', displayName: 'Fantom' },
	{ llamaswap: 'zksync', gecko: 'zksync', displayName: 'ZkSync' },
	{ llamaswap: 'polygonzkevm', gecko: 'polygon-zkevm', displayName: 'Polygon zkEVM' },
	{ llamaswap: 'linea', gecko: 'linea', displayName: 'Linea' },
	{ llamaswap: 'Canto', gecko: 'canto', displayName: 'Canto' },
	{ llamaswap: 'gnosis', gecko: 'xdai', displayName: 'Gnosis XDAI' },
	{ llamaswap: 'klaytn', gecko: 'klay-token', displayName: 'Kaia' },
	{ llamaswap: 'aurora', gecko: 'aurora', displayName: 'Aurora' },
	{ llamaswap: 'cronos', gecko: 'cronos', displayName: 'Cronos' },
	{ llamaswap: 'celo', gecko: 'celo', displayName: 'CELO' },
	{ llamaswap: 'moonriver', gecko: 'moonriver', displayName: 'Moonriver' },
	{ llamaswap: 'heco', gecko: 'huobi-token', displayName: 'Huobi ECO Chain' },
	{ llamaswap: 'boba', gecko: 'boba', displayName: 'Boba Network' },
	{ llamaswap: 'okexchain', gecko: 'okex-chain', displayName: 'OKX Chain' },
	{ llamaswap: 'moonbeam', gecko: 'moonbeam', displayName: 'Moonbeam' },
	{ llamaswap: 'fuse', gecko: 'fuse', displayName: 'Fuse' },
	{ llamaswap: 'oasis', gecko: 'oasis', displayName: 'Oasis Emerald' },
	{ llamaswap: 'ontology', gecko: 'ontology', displayName: 'Ontology' },
	{ llamaswap: 'kava', gecko: 'kava', displayName: 'Kava' },
	{ llamaswap: 'metis', gecko: 'metis-andromeda', displayName: 'Metis' },
	{ llamaswap: 'pulse', gecko: 'pulsechain', displayName: 'Pulsechain' },
	{ llamaswap: 'velas', gecko: 'velas', displayName: 'Velas' },
	{ llamaswap: 'harmony', gecko: 'harmony-shard-0', displayName: 'Harmony' },
