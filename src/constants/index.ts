...
export const RWA_ACTIVE_TVLS_API = `${RWA_SERVER_URL}/current?q=4`
export const RWA_STATS_API = `${RWA_SERVER_URL}/stats?q=4`
export const RWA_ID_MAP_API = `${RWA_SERVER_URL}/id-map?q=4`
export const RWA_LIST_API = `${RWA_SERVER_URL}/list?q=4`
