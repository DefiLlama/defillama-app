...
export const YIELD_BORROW_API = '/api/datasets/borrow'
export const YIELD_BORROW_ADVANCED_API = '/api/datasets/borrow-advanced'
export const YIELD_POOLS_DATASET_API = '/api/datasets/yields/pools'
export const YIELD_LOOP_DATASET_API = '/api/datasets/yields/loop'
export const YIELD_STRATEGY_DATASET_API = '/api/datasets/yields/strategy'
export const YIELD_LONG_SHORT_STRATEGY_DATASET_API = '/api/datasets/yields/strategy-long-short'
export const YIELD_HALAL_DATASET_API = '/api/datasets/yields/halal'
