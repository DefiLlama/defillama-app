...
export const BRIDGEDAYSTATS_API = 'https://bridges.llama.team/bridgedaystats'
export const BRIDGES_API = 'https://bridges.llama.team/bridges'
export const BRIDGEVOLUME_API = 'https://bridges.llama.team/bridgevolume'
export const BRIDGELARGETX_API = 'https://bridges.llama.team/largetransactions'
export const BRIDGETX_API = 'https://bridges.llama.team/transactions'
export const BRIDGEINFLOWS_API = 'https://api.llama.fi/chain-assets/historical-flows'
export const NETFLOWS_API = 'https://bridges.llama.team/netflows'
