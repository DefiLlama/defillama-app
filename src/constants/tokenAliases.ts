export const CANONICAL_TOKEN_ALIASES: Record<string, readonly string[]> = {
	btc: ['btc', 'wbtc', 'cbbtc', 'tbtc', 'fbtc', 'lbtc', 'btcb', 'renbtc', 'hbtc', 'sbtc', 'ibtc', 'mbtc', 'pumpbtc', 'ubtc', 'swbtc', 'solvbtc', 'kbtc', 'enzobtc', 'unibtc', 'xsolvbtc'],
	eth: ['eth', 'weth', 'steth', 'wsteth', 'reth', 'cbeth', 'rseth', 'weeth', 'oseth', 'ezeth', 'pufeth', 'meth', 'frxeth', 'sfrxeth', 'lseth', 'ankreth', 'oeth', 'rsweth', 'sweth', 'wbeth', 'aweth'],
