export const definitions = {
  "fees": {
    ...
    "protocol": {
      ...
      "annualized": "Trailing 12-month (TTM) fees when a full year of data is available, otherwise available history annualized to a 12-month run rate (falls back to 30-day fees ×12.2)",
  ...
  "revenue": {
    ...
    "protocol": {
      ...
      "annualized": "Trailing 12-month (TTM) revenue when a full year of data is available, otherwise available history annualized to a 12-month run rate (falls back to 30-day revenue ×12.2)",
  ...
  "holdersRevenue": {
    ...
    "protocol": {
      ...
      "annualized": "Trailing 12-month (TTM) holders revenue when a full year of data is available, otherwise available history annualized to a 12-month run rate (falls back to 30-day holders revenue ×12.2)",
  ...
  "earnings": {
    ...
    "protocol": {
      ...
      "annualized": "Annualized revenue (TTM when a full year of data is available, otherwise run-rate) minus trailing 12-month incentives (falls back to 30-day earnings ×12.2)",
