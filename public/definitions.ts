export const definitions = {
  "fees": {
    ...
    "protocol": {
      ...
      "annualized": "Trailing 12-month fees when a full year of data is available; otherwise all available tracked fees annualized to a 12-month run rate.",
  ...
  "revenue": {
    ...
    "protocol": {
      ...
      "annualized": "Trailing 12-month revenue when a full year of data is available; otherwise all available tracked revenue annualized to a 12-month run rate.",
  ...
  "holdersRevenue": {
    ...
    "protocol": {
      ...
      "annualized": "Trailing 12-month holders revenue when a full year of data is available; otherwise all available tracked holders revenue annualized to a 12-month run rate.",
  ...
  "earnings": {
    ...
    "protocol": {
      ...
      "annualized": "Annualized protocol revenue minus incentives emitted over the last 12 months",
