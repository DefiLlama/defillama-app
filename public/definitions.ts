export const definitions = {
  "fees": {
    ...
    "protocol": {
      ...
      "annualized": "Annualized fees from tracked history. Uses trailing 12-month fees when at least one full year is available. If less than one full year is available, scales all available tracked fees to a 12-month run rate.",
      "runRate": "Estimated as fees from the last 30 days multiplied by 12.2.",
      "pf": "Market cap divided by annualized fees. Blank when annualized fees are unavailable.",
  ...
  "revenue": {
    ...
    "protocol": {
      ...
      "annualized": "Annualized revenue from tracked history. Uses trailing 12-month revenue when at least one full year is available. If less than one full year is available, scales all available tracked revenue to a 12-month run rate.",
      "runRate": "Estimated as revenue from the last 30 days multiplied by 12.2.",
      "ps": "Market cap divided by annualized revenue. Blank when annualized revenue is unavailable.",
  ...
  "holdersRevenue": {
    ...
    "protocol": {
      ...
      "annualized": "Annualized holders revenue from tracked history. Uses trailing 12-month holders revenue when at least one full year is available. If less than one full year is available, scales all available tracked holders revenue to a 12-month run rate.",
      "runRate": "Estimated as holders revenue from the last 30 days multiplied by 12.2.",
  ...
  "earnings": {
    ...
    "protocol": {
      ...
      "annualized": "Annualized protocol revenue from tracked history minus incentives emitted over the last 12 months. Revenue uses trailing 12 months when at least one full year is available. If less than one full year is available, revenue is scaled to a 12-month run rate.",
      "runRate": "Estimated as net protocol earnings from the last 30 days multiplied by 12.2.",
  ...
  "incentives": {
    ...
    "protocol": {
      ...
      "runRate": "Estimated as incentives from the last 30 days multiplied by 12.2."
    }
  },
  "dexs": {
